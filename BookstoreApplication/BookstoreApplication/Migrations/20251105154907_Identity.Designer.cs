...
namespace BookstoreApplication.Migrations
{
    ...
    [Migration("20251105154907_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.AuthorAward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.Award", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.AuthorAward", b =>
                {
                    b.HasOne("BookstoreApplication.Domain.Author", "Author")
                        .WithMany("AuthorAwards")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookstoreApplication.Domain.Award", "Award")
                        .WithMany("AuthorAwards")
            ...
            modelBuilder.Entity("BookstoreApplication.Domain.Book", b =>
                {
                    ...
                    b.HasOne("BookstoreApplication.Domain.Publisher", "Publisher")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookstoreApplication.Domain.ApplicationUser", null)
                        .WithMany()
